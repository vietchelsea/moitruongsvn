<?php
/*
  Template Name: Home page 3 columns post
 */
?>
   ...
   <!-- Start content -->
     <div class="twelve columns" id="content">
			...
			<div class="post_list_medium_widget" id="content_masonry">
                     ...
                     <style type="text/css">
					 /*.feature-two-column:first-child, #margin-left-post-1, #margin-left-post-2, #margin-left-post-4, #margin-left-post-5, #margin-left-post-7, #margin-left-post-8{margin-right: 2.4% !important;}*/
                     .feature-two-column.full-homepage-post{margin-right: 2.4% !important; width: 31.7% !important;}
					 #empty-margin-post{ margin-right:0px !important;}
				...
				?>
                            ...
                            <div <?php post_class('feature-two-column full-homepage-post loop-post-content'); ?> <?php if($row_count % 3 == 0){echo ' id="empty-margin-post"';}?>>
...
<p><?php echo jellywp_post_excerpt(get_the_excerpt('')); ?> </p>
    					...
    					<?php if($row_count % 3 == 0){echo '<div class="clearfix"></div>';}?>
